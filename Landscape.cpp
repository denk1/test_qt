...
{
	float * pDataConvert= new float[mTerrain->getSize() * mTerrain->getSize()];
    ...
    OgreBulletCollisions::HeightmapCollisionShape* shape = Physics::getSingleton().createHeightmapCollisionShape(landSize,landSize, pDataConvert, mVector3, maxHeight, true);
